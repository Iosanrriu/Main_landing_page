      ...
      <nav className="mx-auto max-w-6xl px-4 py-3" aria-label="Main navigation">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="hidden items-center gap-2 lg:flex">
            ...
            <a href="/career" className="nav-text rounded-full px-3 py-1.5 transition hover:bg-slate-100">
              Career
            </a>
        ...
        <div className="mt-3 flex gap-2 overflow-x-auto pb-1 lg:hidden">
          ...
          <a href="/career" className="whitespace-nowrap rounded-full border border-retro-borderLight bg-white px-3 py-1.5 text-xs font-semibold text-slate-700">
            Career
          </a>
        </div>
      </nav>
